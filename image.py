...
# File uploader for the checkpoint file
uploaded_checkpoint = st.file_uploader("Upload SAM Checkpoint", type=["pth"])
...
if uploaded_checkpoint is not None:
    ...
    sam, animate_pipe = load_models("sam_vit_h_4b8939.pth")
